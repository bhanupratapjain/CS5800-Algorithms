...
//        }
    ...
    private void deleteFixup(RedBlackNode x) {
        RedBlackNode w = null;
        while ((x != nil ||x != null) && x.color == RedBlackNode.Color.BLACK) {
            if (x == x.parent.left) {
                w = x.parent.right;
                if (w.color == RedBlackNode.Color.RED) {
                    w.color = RedBlackNode.Color.BLACK;
                    w.parent.color = RedBlackNode.Color.RED;
                    rotateLeft(x.parent);
                    w = x.parent.right;
                }
                ...
                if (w.right.color == RedBlackNode.Color.BLACK && w.left.color == RedBlackNode.Color.BLACK) {
                    w.color = RedBlackNode.Color.RED;
                    x = x.parent;
                } else {
     ...
     * @param x the x
     */
    private void deleteFixup2(RedBlackNode x) {
        RedBlackNode w = null;
